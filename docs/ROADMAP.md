...
| M5  | Feel & polish         | parallax, coin FX, shake/hit-stop, WebAudio SFX, score pop-ups                          | ◐ hit-stop, shake, key poses  |
| M6  | Screens               | title, how-to, settings (sound/quality/controls), pause, game-over card                 | ◐ home, name, locale, receipt |
...
- More locales (`hi`, `ar`) behind the same bundle-completeness test.
