...
STATES: dict[str, dict[str, Any]] = {
    ...
    "run": {
        ...
        "hold": None,
        "keys": [
            # contact: left leg reaches forward, right leg pushes back
            K(
                0,
                leg_left={"rot": 26, "pos": (-2, 0)},
                leg_right={"rot": -24, "pos": (2, 0)},
                arm_left={"rot": -20},
                arm_right={"rot": 20},
                torso={"rot": 3, "scale": (1.02, 0.985), "pos": (0, 3)},
                head={"rot": -2.5, "pos": (0, 2)},
                cape_left={"rot": 9},
                cape_right={"rot": 12},
            ),
            # passing: support leg under the body, free leg lifted
            K(
                2,
                leg_left={"rot": 2, "pos": (0, -7)},
                leg_right={"rot": -4, "pos": (0, 1)},
                arm_left={"rot": 6},
                arm_right={"rot": -6},
                torso={"rot": 1, "scale": (0.99, 1.02), "pos": (0, -3)},
                head={"rot": 1, "pos": (0, -2)},
                cape_left={"rot": -5},
                cape_right={"rot": -7},
            ),
            ...
            K(
                4,
                leg_left={"rot": -24, "pos": (2, 0)},
                leg_right={"rot": 26, "pos": (-2, 0)},
                arm_left={"rot": 20},
                arm_right={"rot": -20},
                torso={"rot": 3, "scale": (1.02, 0.985), "pos": (0, 3)},
                head={"rot": 2.5, "pos": (0, 2)},
            ...
            K(
                6,
                leg_left={"rot": -4, "pos": (0, 1)},
                leg_right={"rot": 2, "pos": (0, -7)},
                arm_left={"rot": -6},
                arm_right={"rot": 6},
                torso={"rot": 1, "scale": (0.99, 1.02), "pos": (0, -3)},
                head={"rot": -1, "pos": (0, -2)},
            ...
            K(8, leg_left={"rot": 26}, leg_right={"rot": -24}, arm_left={"rot": -20}, arm_right={"rot": 20}),
        ],
    },
    "dash": {
        "fps": 14,
    ...
    "land": {
        ...
        "keys": [
            ...
            K(
                ...
                arm_left={"rot": -8},
                arm_right={"rot": 8},
                torso={"scale": (0.99, 1.03), "pos": (0, -2)},
                head={"pos": (0, -2), "rot": -3},
            ),
            K(4, torso={"scale": (1.0, 1.0)}),
        ],
    },
    # ------------------------------------------------------------------- tech
    "slide": {
        # Feet-first board slide: legs swing out front, torso leans back, the cape
        # trails. Posed with rig joints (no body rotation) so it can never clip.
        "fps": 18,
        "loop": False,
        "count": 4,
        "hold": 2,
        "keys": [
            K(
                0,
                torso={"rot": 12, "pos": (0, 8), "scale": (1.05, 0.95)},
                leg_left={"rot": 16},
                leg_right={"rot": -14},
                arm_left={"rot": -22},
                arm_right={"rot": 20},
            ...
            K(
                1,
                g={"rot": -10, "pivot": (0.5, 0.74)},
                torso={"rot": -26, "pos": (-6, 14), "scale": (1.03, 0.97)},
                leg_left={"rot": 46},
                leg_right={"rot": 34},
                arm_left={"rot": -54},
                arm_right={"rot": 48},
            ...
            K(
                2,
                g={"rot": -10, "pivot": (0.5, 0.74)},
                torso={"rot": -24, "pos": (-6, 14), "scale": (1.02, 0.98)},
                leg_left={"rot": 42},
                leg_right={"rot": 30},
                arm_left={"rot": -50},
                arm_right={"rot": 44},
